      ...
      <main className="flex-1 bg-gradient-to-br from-blue-500 to-green-500">
        <div className="container mx-auto max-w-4xl py-12 px-4">
          <div className="bg-card/80 backdrop-blur-sm p-8 rounded-lg">
            <h1 className="text-3xl font-bold tracking-tight sm:text-4xl text-card-foreground">গোপনীয়তা নীতি</h1>
            ...
            <div className="prose prose-lg mt-8 max-w-none dark:prose-invert text-card-foreground">
              ...
              <ul>
                <li><strong>ব্যক্তিগত তথ্য:</strong> নিবন্ধনের সময় আপনার নাম, ইমেল ঠিকানা।</li>
                <li><strong>ভেরিফিকেশন তথ্য:</strong> আপনার অ্যাকাউন্টের নিরাপত্তা নিশ্চিত করার জন্য এনআইডি ভেরিফিকেশনের সময় আপনার নাম, এনআইডি নম্বর, জন্ম তারিখ এবং ঠিকানা সংগ্রহ করা হতে পারে।</li>
                <li><strong>আর্থিক তথ্য:</strong> আপনার দ্বারা введен আয়, ব্যয়, ধার, বাকি এবং সঞ্চয়ের তথ্য। এই তথ্যগুলো আপনার ডিভাইসে এবং আমাদের সুরক্ষিত সার্ভারে সংরক্ষিত থাকে।</li>
                <li><strong>পেমেন্ট তথ্য:</strong> আপনি যখন প্রিমিয়াম সাবস্ক্রিপশন কিনবেন, তখন আপনার পেমেন্ট মাধ্যম এবং অ্যাকাউন্ট নম্বর সংগ্রহ করা হয়। আমরা কোনো পেমেন্ট গেটওয়ের মাধ্যমে লেনদেন প্রক্রিয়া করি এবং আপনার সংবেদনশীল পেমেন্ট তথ্য সংরক্ষণ করি না।</li>
              ...
              <ul>
                ...
                <li>আপনার আর্থিক লেনদেন প্রক্রিয়া করতে এবং রেকর্ড সংরক্ষণ করতে।</li>
                <li>এনআইডি ভেরিফিকেশন এবং প্রিমিয়াম সাবস্ক্রিপশন প্রক্রিয়া সম্পন্ন করতে।</li>
                <li>আমাদের অ্যাপের পরিষেবা উন্নত করতে এবং নতুন ফিচার যুক্ত করতে।</li>
                <li>প্রয়োজনে আপনাকে গুরুত্বপূর্ণ নোটিফিকেশন বা আপডেট পাঠাতে।</li>
                 <li>বিজ্ঞাপন প্রদর্শনের জন্য আপনার সাধারণ ব্যবহারের ডেটা (কোনো ব্যক্তিগত সনাক্তকরণযোগ্য তথ্য ছাড়া) ব্যবহার করা হতে পারে।</li>
              </ul>

              <h2 className="mt-8 text-2xl font-semibold">তথ্য শেয়ারিং</h2>
              <p>আমরা আপনার অনুমতি ছাড়া কোনো তৃতীয় পক্ষের কাছে আপনার ব্যক্তিগত বা আর্থিক তথ্য বিক্রি বা ভাড়া দিই না। তবে, নিম্নলিখিত ক্ষেত্রে তথ্য শেয়ার করা হতে পারে:</p>
              <ul>
                <li>আইনি প্রয়োজনে বা আদালতের আদেশ অনুযায়ী।</li>
